...
public class OdinClientSctpMany{

	private static final String outFile = "sctp_output.csv";
	private SctpMultiChannel dataSrvrChannl;
    ...
    */
	...
	public OdinClientSctpMany(String ctrIp, int ctrPort, int dataPort, String reqFileName) {
		this.ctrIp = ctrIp;
    ...
    public void setupSock() throws UnknownHostException, IOException{
		...
		dataSrvrChannl = SctpMultiChannel.open();
    ...
    public void sndFileReq() throws IOException, ParseException{	
	    ...
	    while(true){
		    ...
		    mesgInfo = dataSrvrChannl.receive(mesgBuf, null, null);		    
		    mesgBuf.flip();	        		    
	...
	public void dwnldFile(String fileName, long fileSize, String startTime, Association assoc) throws IOException, ParseException{
		...
		+dataSrvrChannl.getRemoteAddresses(assoc));
	    int start;
